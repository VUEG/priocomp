...
raw_data_files <- list.files(file.path(data_path, "external"), 
...
es_stack <- raster::stack(raw_rasters[[2]], 
                          normalize(raw_rasters[[2]]),
                          ol_normalize(raw_rasters[[2]]),
                          standardize(raw_rasters[[2]]),
                          IQRize(raw_rasters[[2]]))
names(es_stack) <- c("Original", "Normalized", "OL_normalized", "Standardized", "IQRized")
grid.arrange(
