...
if (basename(getwd()) == "priocomp") {
  data_path <- "data/processed/features/provide/"
} else {
  data_path <- "../../data/processed/features/provide/"
}
...
rasterVis::levelplot(rasters, layers = 1, margin = list(FUN = 'mean'),    
...
```{r histogram-1}
ggplot2::qplot(getValues(rasters[[1]]), geom = "histogram", bins = 50, 
               xlab = "Value")
```
