...
cell_count <- lapply(c(rwr_top10, abf_top10, milp_mc[[2]]), function(x) table(raster::getValues(x))) 
...
milp_zonal <- zonal_stats(milp_mc_hier, sp_rasters_normalized, rcl, "MILP")
